...
local function SetupAI()
    ...
    -- Keep compact strategic-AI status in BZLogger for mission playtests.
    aiCore.Telemetry = true
    ...
    if aiCore and aiCore.ActiveTeams and aiCore.ActiveTeams[2] then
        ...
        cca.Config.baseThreatResponse = true
        cca.Config.baseThreatAlertRadius = 425.0
        cca.Config.baseThreatResponseRadius = 700.0
        cca.Config.baseThreatMaxResponders = 8
        cca.Config.tacticalMinSquadUnits = 3
        cca.Config.tacticalMaxSquadUnits = 5
        cca.Config.flankAttackChance = 30
        cca.Config.flankFormationRushChance = 20

        -- High-level Base Planning
        cca:PlanDefensivePerimeter(4, 1) -- four powered gun-tower sectors around the base
