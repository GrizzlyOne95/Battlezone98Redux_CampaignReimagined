...
// TextArea vertices are generated by Ogre rather than BZR's native sprite
// builder. Ogre's D3D11 RenderSystem has already converted ColourValue into the
// vertex format, so this path must keep RGBA order. CR_UI_vertexHLSL4 applies
// the stock BZR BGRA correction and would swap orange and blue here.
void overlay_text_vertex(
