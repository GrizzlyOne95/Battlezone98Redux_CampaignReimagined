...
-- Handles (init to nil)
    svrec = nil, pu1 = nil, pu2 = nil, pu3 = nil, pu4 = nil, pu5 = nil, pu6 = nil, pu7 = nil, pu8 = nil, navbeacon = nil,
    cheat1 = nil, cheat2 = nil, cheat3 = nil, cheat4 = nil, cheat5 = nil, cheat6 = nil, cheat7 = nil, cheat8 = nil, cheat9 = nil, cheat10 = nil,
    tug = nil, svtug = nil, tuge1 = nil, tuge2 = nil,
    player = nil, surv1 = nil, surv2 = nil, surv3 = nil, surv4 = nil,
    cam1 = nil, cam2 = nil, cam3 = nil, basecam = nil, reliccam = nil,
    avrec = nil, w1u1 = nil, w1u2 = nil,
    ...
    spawn1 = nil, spawn2 = nil, spawn3 = nil, relic = nil,
    calipso = nil, turret1 = nil, turret2 = nil, turret3 = nil, turret4 = nil,
    
    aud1 = nil, aud2 = nil, aud3 = nil, aud4 = nil, aud20 = nil, aud21 = nil, aud22 = nil, aud23 = nil,
...
function AddObject(h)
    ...
    if exu and M.difficulty >= 2 and team == 2 and IsOdf(h, "vehicle") then
        exu.SetUnitTurbo(h, 2.5) -- Speed boost for enemy units
    end
...
function Update()
	...
	if (M.discoverrelic) and (M.cintime1 > GetTime()) and (not M.cin1done) then
		if M.relicstartpos == 0 then CameraPath("reliccin1", 500, 400, M.relic)
		elseif M.relicstartpos == 1 then CameraPath("reliccin2", 500, 400, M.relic)
		elseif M.relicstartpos == 2 then CameraPath("reliccin3", 500, 400, M.relic)
		elseif M.relicstartpos == 3 then CameraPath("reliccin4", 500, 400, M.relic)
		end
	end
	...
	if (M.missionwon) and (not M.missionend) then -- Fixed missionend var name? Original was endmission? M.missionend declared.
